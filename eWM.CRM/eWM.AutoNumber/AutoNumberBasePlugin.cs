...
{
    public abstract partial class AutoNumberBasePlugin : IPlugin
    {
        ...
        /// <summary>
        /// Initializes a new instance of the AutoNumberBasePlugin class.
        /// </summary>
        internal AutoNumberBasePlugin(string unsecureConfig, string secureConfig)
        {
