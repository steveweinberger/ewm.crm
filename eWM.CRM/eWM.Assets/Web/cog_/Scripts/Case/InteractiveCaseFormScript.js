...
COG.Library.Case = {
    ...
    AttachEvents: function () {
        ...
        Xrm.Page.getAttribute("cog_reviewtype").addOnChange(COG.Library.Case.ToggleOnsiteDate);
        ...
        if (Xrm.Page.getAttribute(datefield)) {
            ...
            if (duedate != null) {
                if (comparedate.setHours(0, 0, 0, 0) > duedate.setHours(0, 0, 0, 0)) {
                    ...
                    Xrm.Page.ui.clearFormNotification(alertname);
                }
            }
        }
    },
    ...
    LoadDocs: function () {
        ...
        var typecode = Xrm.Page.context.getQueryStringParameters().typecode();
